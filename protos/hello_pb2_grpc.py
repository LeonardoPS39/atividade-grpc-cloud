...
class SaudacaoServiceStub(object):
...
class SaudacaoServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_SaudacaoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'hello.SaudacaoService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('hello.SaudacaoService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class SaudacaoService(object):
    """Missing associated documentation comment in .proto file."""
